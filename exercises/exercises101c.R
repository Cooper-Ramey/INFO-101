...
# indexing
View(rovs)
rovs[rovs$model, ]     # Not sure why this doesn't work...
rovs$model     #This returns the first column
...
flowcyto[flowcyto$abundance > 400, ]# Pull out all rows where abundance was more than 400
flowcyto[flowcyto$station_id == 1 & flowcyto$cast == 1, 5]# Pull out the abundances from the first cast at the first station
flowcyto[flowcyto$station_id == 1 & flowcyto$cast == 1, 5] <- NA# Set all the values in abundance to NA for the first cast at the first station
